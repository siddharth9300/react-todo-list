...
export default function Header(props) {
  return (
    ...
    <header className="text-gray-600 body-font fixed  z-10 w-full bg-white md:border-b md:border-gray-400 shadow shadow-black/20">
      <div className="container mx-auto ml-10 flex flex-wrap p-5 flex-col md:flex-row ">
        <Link
        ...
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
          ...
          <img
            ...
            srcset=""
          />
          <span className="ml-3 text-xl mt-2">{props.title}</span>
        </Link>
        <nav className="md:mr-auto	flex flex-wrap mt-2 text-base justify-center ">
      ...
      <div className="fixed z-10 h-0 flex flex-row-reverse w-full ">
    <Search/>   
    </div>
    </>
  );
