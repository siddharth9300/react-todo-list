...
<section className="text-gray-600 my-4 border-gray-400 border-4 border-solid rounded-3xl body-font overflow-hidden dark:bg-slate-900" id={"scroll-"+todo.sno}>
    ...
    <div className=" divide-y-2  divide-gray-100">
      ...
      <div className="py-8 flex flex-wrap md:flex-nowrap">
        ...
        <div className="md:flex-grow ">
          ...
          <p className="leading-relaxed dark:text-gray-200 break-words " id={"desc"+todo.sno}>{todo.desc}</p>
